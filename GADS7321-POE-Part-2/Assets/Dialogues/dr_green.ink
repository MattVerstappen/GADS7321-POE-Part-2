...
+ [Happy]
    <disruption>That makes me feel <color=\#F8FF30>happy</color> as well!</disruption> #portrait:dr_green_happy
+ [Sad]
    Oh, well <disruption>that makes me </disruption><color=\#5B81FF>sad</color> too. #portrait:dr_green_sad
