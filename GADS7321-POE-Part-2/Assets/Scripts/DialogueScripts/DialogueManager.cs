...
{
    // Ensure audio clips are available
    if (currentAudioInfo.dialogueTypingSoundClips == null || currentAudioInfo.dialogueTypingSoundClips.Length == 0)
    {
        Debug.LogWarning("No dialogue typing sound clips available.");
        return;
    }
